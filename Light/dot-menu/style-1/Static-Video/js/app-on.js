...
jQuery(document).ready(function () {
	...
	if (onMobile === true) {
        ...
        $('#home-section').css({background: 'url(images/background/1-1920x1200.jpg) center center'});
        $('#home-blog-section').css({background: 'url(images/background/1-1920x1200.jpg) center center'});
    } else {
        /* ==========================================================================
        Tubular
        ========================================================================== */
        $(function () {
            $('#home-section').tubular({
                videoId: '3RCTV4mWyXc',
                repeat: true,
                start: 0
            });
